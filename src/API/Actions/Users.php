...
use ctapu4ok\VkMessengerSdk\API\Actions\Enums\UsersSex;
use ctapu4ok\VkMessengerSdk\API\Actions\Enums\UsersSort;
use ctapu4ok\VkMessengerSdk\API\Actions\Enums\UsersStatus;
use ctapu4ok\VkMessengerSdk\API\Actions\Enums\UsersType;
...
class Users implements ActionInterface
{
    ...
    {
        return $this->request->post('users.getFollowers', $params);
    }
    ...
    {
        return $this->request->post('users.getSubscriptions', $params);
    }
    ...
    {
        return $this->request->post('users.report', $params);
    }
    ...
    {
        return $this->request->post('users.search', $params);
    }
}
